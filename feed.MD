...
- Posting menambah `bahan.stok_onhand` serta membuat `inventory_layers`.
- Jurnal LPB:
...
- Layer dengan tanggal/ID tertua dikonsumsi lebih dahulu.
...
| Master | `suppliers`, `admin_namagudang`, `bahan`, `kategoribahan`, `tipe_pembebanans` |
