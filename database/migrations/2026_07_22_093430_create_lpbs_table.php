...
return new class extends Migration
{
    ...
    {
        Schema::create('wms_penerimaan_barang', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('status', ['DRAFT', 'POSTED', 'REVERSED', 'CANCELLED'])->default('DRAFT')
                ->comment('Lifecycle penerimaan: DRAFT, POSTED, REVERSED, atau CANCELLED');
    ...
    {
        Schema::dropIfExists('wms_penerimaan_barang');
    }
};
