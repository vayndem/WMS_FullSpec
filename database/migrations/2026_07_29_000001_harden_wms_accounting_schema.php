    ...
    public function up(): void
    {
        ...
        DB::table('inventory_layers')->insertUsing(
            ...
            DB::table('wms_penerimaan_barang_detail')
                ...
                ->join('bahans', 'bahans.id', '=', 'wms_penerimaan_barang_detail.id_bahan')
                ->select([
                    'wms_penerimaan_barang_detail.id_bahan',
                    'bahans.tipe_gudang',
                    DB::raw("'LPB_DETAIL'"),
                    'wms_penerimaan_barang_detail.id',
                    'wms_penerimaan_barang.tanggal',
                    'wms_penerimaan_barang_detail.jumlah_barang_diterima',
                    DB::raw('GREATEST(wms_penerimaan_barang_detail.jumlah_barang_diterima - wms_penerimaan_barang_detail.jumlah_dipakai, 0)'),
                    DB::raw('COALESCE(wms_penerimaan_barang_detail.harga, 0)'),
