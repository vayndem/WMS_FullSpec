...
class UpdatePenerimaanBarangRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        if (is_string($lpb)) {
            $lpb = PenerimaanBarang::where('id', $lpb)->orWhere('id_lpb', $lpb)->first();
        }
    ...
    public function rules(): array
    {
        return [
            ...
            'details.*.id'                     => 'nullable|integer|exists:wms_penerimaan_barang_detail,id',
