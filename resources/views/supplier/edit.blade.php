<dialog id="supplierEditModal" class="modal">
    <div class="modal-box max-w-2xl p-0 overflow-hidden">
        <div class="flex items-center gap-3 bg-warning px-6 py-4 text-warning-content">
            ...
            <div>
                ...
                <p class="text-sm text-warning-content/80">Perbarui informasi data vendor di bawah ini</p>
            </div>
        </div>
        <form action="{{ route('supplier.update', $supplier->id) }}" method="POST" class="flex flex-col">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1 gap-4 p-6 sm:grid-cols-2">
                <div class="form-control">
                    ...
                    <div class="join">
                        ...
                        <input type="text" name="nama" value="{{ $supplier->nama }}" class="input input-bordered join-item flex-1"
                ...
                <div class="form-control">
                    ...
                    <div class="join">
                        ...
                        <input type="text" name="up" value="{{ $supplier->up }}" class="input input-bordered join-item flex-1"
                ...
                <div class="form-control">
                    ...
                    <div class="join">
                        ...
                        <input type="text" name="telp" value="{{ $supplier->telp }}" class="input input-bordered join-item flex-1"
                ...
                <div class="form-control">
                    ...
                    <div class="join">
                        ...
                        <input type="text" name="npwp" value="{{ $supplier->npwp }}" class="input input-bordered join-item flex-1"
                ...
                <div class="form-control">
                    ...
                    <div class="join">
                        ...
                        <input type="text" name="pembayaran" value="{{ $supplier->pembayaran }}" class="input input-bordered join-item flex-1"
            ...
            <div class="flex justify-end gap-2 border-t border-base-300 bg-base-100 px-6 py-4">
                ...
                <button type="submit" class="btn btn-warning">
                    <i class="fa-solid fa-pen-to-square"></i> Perbarui Supplier
                </button>
            </div>
        </form>
    </div>
