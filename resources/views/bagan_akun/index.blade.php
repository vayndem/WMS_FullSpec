                ...
                <div class="collapse-content">
                    <form action="{{ route('bagan-akun.mapping.update') }}" method="POST"
                        ...
                        <div class="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                            @foreach (['HUTANG_USAHA' => 'Hutang Supplier', 'PPN_MASUKAN' => 'PPN Masukan', 'PPN_IMPOR' => 'PPN Masukan Impor', 'HUTANG_PPH23' => 'Hutang PPh 23', 'HUTANG_PPH22' => 'Hutang PPh 22', 'HUTANG_PPH4A2' => 'Hutang PPh 4(2) Final', 'BIAYA_BANK' => 'Biaya Bank', 'BEBAN_MATERAI' => 'Beban Materai', 'SELISIH_BAYAR' => 'Selisih Bayar', 'BIAYA_ONGKIR' => 'Biaya Angkut', 'DISKON_PEMBELIAN' => 'Diskon Pembelian', 'UANG_MUKA_SUPPLIER' => 'Uang Muka Supplier'] as $key => $label)
